...
$where_clause = "WHERE categoria = 'Portal' AND status = 'ativo'";
$params = [];
...
<head>
    ...
    <title>Blog - TI Grupo Barão</title>
    ...
    <section class="hero-section">
        <div class="container-custom">
            <div class="hero-content">
                <h1 class="hero-title">Blog TI Grupo Barão</h1>
                <p class="hero-subtitle">Fique por dentro das últimas novidades e atualizações</p>
    ...
    <div class="container-custom">
        ...
        <div class="stats-bar">
            <div class="stats-info">
                ...
                <span><?php echo $total_noticias; ?> notícia(s) encontrada(s)</span>
                <?php if (!empty($busca)): ?>
                ...
                <?php foreach ($noticias as $noticia): ?>
                    <article class="blog-card">
                        ...
                        <div class="blog-content">
                            ...
                            <a href="blog_post.php?id=<?php echo $noticia['id']; ?>&from=blog" class="read-more-btn">
                                Leia mais
        ...
        <?php else: ?>
            <div class="no-results">
                ...
                <p>Tente ajustar sua busca ou navegue pelas notícias mais recentes.</p>
                <?php if (!empty($busca)): ?>
                    <a href="blog.php" class="read-more-btn" style="margin-top: 1rem;">
